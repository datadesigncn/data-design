> 快速链接: [我们的许可方式](https://github.com/infoactive/data-design#how-were-licensed) &bull; [参与贡献](https://github.com/infoactive/data-design#can-i-make-edits) &bull; [Atlas构建方式](https://github.com/infoactive/data-design#building-with-atlas)

# 我们的许可方式

*数据 + 设计* is licensed under the terms of a [署名-非商业性使用-相同方式共享 (by-nc-sa)](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode). The full legal code is at the link, but here's a quick human-readable breakdown for you as well. (Note: This is only a human-readable summary of, and not a substitute for or supplement to, the license.)
...
这是最好的选项，如果你想在你自己的方向上行进，或者想要自己的副本用于参考，或者只是想要增加一个新的章节。对于大多数人来说，这就是最好的选项。
...
没有更好的了。这事操作起来超级简单。只需要[访问代码库](https://github.com/infoactive/data-design)并点击右上角的"Fork"按钮。乌拉！你现在已经是
